...
export default function BottomNav() {
  ...
  return (
    ...
    >
      <div className="mx-4 mb-4 bg-slate-950/60 backdrop-blur-2xl border border-white/10 rounded-2xl flex items-center justify-around py-3 px-1 shadow-[0_-8px_32px_rgba(0,0,0,0.6)] pointer-events-auto">
        {NAV_ITEMS.map((item) => {
