  ...
  return (
    <AnimatePresence>
      {isVisible && (
        ...
        >
          <Link href="https://360tuongtac.com/user/recharge" className="block glass-panel rounded-xl p-3 w-[260px] border border-[#FF8C00]/30 hover:border-[#FF8C00]/60 hover:scale-105 transition-all duration-300">
