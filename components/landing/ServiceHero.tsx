...
export default function ServiceHero({ badge, title, description, productUrl, serviceSlug }: ServiceHeroProps) {
  ...
  return (
    <section className="relative pt-8 pb-16 md:pt-12 md:pb-24 overflow-hidden border-b border-[var(--border)] bg-[var(--bg)]">
      {/* Background Orbs */}
      ...
      <div className="container-max px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[var(--surface)] border border-[var(--border)] mb-8 shadow-sm"
          >
            <span className="flex h-2 w-2 rounded-full bg-[#FF2E63] animate-ping"></span>
            <span className="font-stat text-[10px] font-black tracking-[0.3em] uppercase text-[var(--text-secondary)]">{badge}</span>
          </motion.div>
          ...
          <motion.p
            ...
            className="font-body text-[var(--text-secondary)] text-lg md:text-xl mb-12 leading-relaxed mx-auto max-w-3xl font-medium"
          >
            {description}
          </motion.p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mb-16">
            ...
            <Link 
               ...
               className="px-12 py-5 rounded-2xl glass-panel text-[var(--text-primary)] font-black text-xl hover:bg-[var(--surface-hover)] transition-all duration-300 antialiased flex items-center gap-3 shadow-sm"
            >
          ...
          >
            <div className="flex items-center gap-2 text-[var(--text-muted)] font-bold uppercase text-[10px] tracking-widest">
