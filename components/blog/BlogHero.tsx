...
export default function BlogHero() {
  return (
    <div className="text-center mb-16 md:mb-24 relative pt-12 md:pt-20">
      ...
      >
        <div className="inline-flex items-center gap-2 mb-6 px-5 py-2 rounded-full glass-panel border border-white/10 shadow-xl">
          ...
          <span className="text-[10px] font-black tracking-[0.2em] uppercase text-slate-300">KIẾN THỨC GROWTH</span>
        </div>

        <h1 className="font-h1 text-4xl md:text-5xl lg:text-7xl font-black mb-8 leading-tight tracking-tight text-white antialiased">
          Học Viện <span className="bg-gradient-to-r from-[#FF8C00] via-[#FF2E63] to-[#8B5CF6] bg-clip-text text-transparent">360TuongTac</span>
        </h1>
        
        <p className="font-body text-slate-400 text-lg md:text-xl max-w-3xl mx-auto leading-relaxed">
