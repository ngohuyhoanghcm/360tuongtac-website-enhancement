    ...
    <section className="py-24 md:py-32 relative overflow-hidden">
      <div className="container-max px-6">
        <motion.div
          ...
          viewport={{ once: true }}
          className="glass-panel rounded-[4rem] p-12 md:p-24 text-center shadow-xl relative overflow-hidden group"
        >
          {/* Animated Glows */}
          ...
          <div className="relative z-10">
            <motion.div
              ...
              viewport={{ once: true }}
              className="inline-block mb-8 px-6 py-2 rounded-full glass-panel"
            >
              <span className="font-stat text-xs font-black tracking-[0.3em] uppercase text-[#FF8C00]">Liên hệ ngay</span>
            </motion.div>

            <h2 className="font-h1 text-3xl md:text-6xl font-black text-[var(--text-primary)] mb-8 leading-tight tracking-tight antialiased">
              Cảm thấy dịch vụ <br className="hidden md:block" /> 
              <span className="text-gradient">phù hợp với bạn?</span>
            </h2>
            
            <p className="font-body text-[var(--text-secondary)] text-lg md:text-xl mb-12 max-w-2xl mx-auto font-medium leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.98 }}>
                <Link 
                  ...
                  className="px-12 py-5 rounded-2xl bg-gradient-to-r from-[#0068FF] to-[#00E5FF] dark:from-[#0a1628] dark:to-[#0068FF] text-white dark:text-[var(--text-primary)] font-black text-lg shadow-xl hover:shadow-2xl hover:shadow-[#0068FF]/25 dark:hover:shadow-[#0068FF]/15 hover:scale-105 transition-all duration-300 antialiased block"
                >
                  Tư Vấn Zalo
                </Link>
              </motion.div>
              ...
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.98 }}>
                <Link 
                  href={ctaUrl} 
                  className="px-12 py-5 rounded-2xl glass-panel text-[var(--text-primary)] font-black text-lg hover:bg-[var(--surface-hover)] hover:border-[#FF2E63]/40 transition-all duration-300 antialiased block"
                >
                  Đặt Mua Ngay
                </Link>
              </motion.div>
