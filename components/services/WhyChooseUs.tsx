      ...
      <div className="container-max px-6">
        <div className="text-center mb-16 md:mb-24">
          ...
          >
            ...
            <p className="font-body text-[var(--text-secondary)] max-w-2xl mx-auto font-medium text-lg leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {TRUST_PILLARS.map((pillar, i) => (
            <motion.div
              ...
              className="bg-[var(--surface)] p-10 rounded-[2.5rem] border border-[var(--border)] relative overflow-hidden group hover:border-[var(--border-hover)] transition-all duration-500 text-center shadow-md hover:shadow-lg"
            >
              ...
              <h3 className="font-h1 text-xl font-bold text-[var(--text-primary)] mb-4 tracking-tight group-hover:text-[#FF8C00] transition-colors antialiased">
                {pillar.title}
              </h3>
