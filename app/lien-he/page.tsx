...
export default function Contact() {
  return (
    <div className="relative min-h-screen bg-gray-50 overflow-hidden py-24 mt-16 sm:mt-24">
      ...
      <div className="relative max-w-[1440px] mx-auto px-6 lg:px-12">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white border border-gray-200 mb-6 shadow-md">
          ...
          <h1 className="font-h1 text-5xl md:text-6xl font-black text-gray-900 mb-6 tracking-tight">KẾT NỐI <span className="bg-gradient-to-r from-[#FF8C00] via-[#FF2E63] to-[#8B5CF6] text-transparent bg-clip-text">BỨT PHÁ</span></h1>
          <p className="font-body text-xl text-gray-600 max-w-2xl mx-auto font-medium">
        ...
        <motion.div 
          ...
          className="bg-white backdrop-blur-xl border border-gray-200 rounded-[2.5rem] overflow-hidden shadow-xl p-6 md:p-8 lg:p-12 relative"
        >
          <div className="absolute inset-0 bg-gradient-to-br from-gray-50 to-transparent pointer-events-none"></div>
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pb-2">
                  <a href="https://zalo.me/0388009669" target="_blank" rel="noreferrer" className="relative group overflow-hidden rounded-2xl p-[1px]">
                    ...
                    <div className="relative flex items-center justify-center gap-2 py-3 bg-gray-50 rounded-2xl transition-all duration-500 group-hover:bg-gray-100 h-full">
                      <span className="font-h1 font-bold text-gray-900 text-sm tracking-wide text-center">Zalo<br/>Tư Vấn</span>
                    </div>
                  </a>
                  ...
                  <a href="https://zalo.me/g/stizun489" target="_blank" rel="noreferrer" className="relative group overflow-hidden rounded-2xl p-[1px]">
                    ...
                    <div className="relative flex items-center justify-center gap-2 py-3 bg-gray-50 rounded-2xl transition-all duration-500 group-hover:bg-gray-100 h-full">
                      <span className="font-h1 font-bold text-gray-900 text-sm tracking-wide text-center">Nhóm<br/>Zalo</span>
                    </div>
                  </a>
                  ...
                  <a href="https://t.me/CSKH360TuongTac" target="_blank" rel="noreferrer" className="relative group overflow-hidden rounded-2xl p-[1px]">
                    ...
                    <div className="relative flex items-center justify-center gap-2 py-3 bg-gray-50 rounded-2xl transition-all duration-500 group-hover:bg-gray-100 h-full">
                      <span className="font-h1 font-bold text-gray-900 text-sm tracking-wide text-center">Telegram<br/>CSKH</span>
                    </div>
                  </a>
                </div>

                {/* 3D Isometric Styled Cards */}
                <div className="group relative bg-white border border-gray-200 p-6 rounded-3xl hover:border-[#FF8C00]/50 transition-all duration-500 overflow-hidden shadow-md hover:shadow-lg hover:-translate-y-1">
                  ...
                  <div className="flex items-center gap-6 relative z-10">
                    ...
                    <div>
                      <h3 className="font-stat text-sm font-bold text-gray-500 tracking-wider uppercase mb-1">Hotline VIP</h3>
                      <p className="font-h1 font-bold text-2xl text-gray-900 group-hover:text-[#FF8C00] transition-colors">0388.00.9669</p>
                    </div>
                  </div>
                </div>

                <div className="group relative bg-white border border-gray-200 p-6 rounded-3xl hover:border-[#FF2E63]/50 transition-all duration-500 overflow-hidden shadow-md hover:shadow-lg hover:-translate-y-1">
                  ...
                  <div className="flex items-center gap-6 relative z-10">
                    ...
                    <div>
                      <h3 className="font-stat text-sm font-bold text-gray-500 tracking-wider uppercase mb-1">Email Support</h3>
                      <p className="font-h1 font-bold text-xl text-gray-900 group-hover:text-[#FF2E63] transition-colors">contact@flowra.vn</p>
                    </div>
                  </div>
                </div>

                <div className="group relative bg-white border border-gray-200 p-6 rounded-3xl hover:border-[#8B5CF6]/50 transition-all duration-500 overflow-hidden shadow-md hover:shadow-lg hover:-translate-y-1">
                  ...
                  <div className="flex items-center gap-6 relative z-10">
                    ...
                    <div>
                      <h3 className="font-stat text-sm font-bold text-gray-500 tracking-wider uppercase mb-1">HQ Office</h3>
                      <p className="font-body font-medium text-gray-900 text-lg pr-4 group-hover:text-[#8B5CF6] transition-colors">
